...
|  | Tu 9/24 to F 9/26 | **Exam 1** (No Class Session on F 9/26) |
...
| **9** | M 10/20 | _Cancelled_ |
|  | W 10/22 | _Review_ |
|  | F 10/24 | Eigenvalues and Eigenvectors for Homogeneous Linear Systems |
| **10** | M 10/27 | Stability Analysis by Linearization |
...
| **11** | M 11/3 | Distinct Eigenvalues |
|  | W 11/5 | Repeated Eigenvalues |
|  | F 11/7 | Complex Eigenvalues |
| **12** | M 11/10 | Variation of Parameters for Nonhomogeneous Linear Systems |
|  | W 11/12 | Bifurcations in Two Dimensions |
|  | F 11/14 | _Review_ |
| **13** | M 11/17 | Laplace and Inverse Laplace Transforms |
|  | W 11/19 | Laplace Transforms for Homogeneous Linear ODEs |
|  | F 11/21 | Laplace Transforms for Nonhomogeneous Linear ODEs |
...
|  |  | A | - | - | $\frac{2}{4}$ | - |
|  |  | NI | - | - | - | $\frac{2}{4}$ |
| **Homeworks** | 2 | O | $\frac{5}{5}$ | - | - | - |
|  |  | E | - | $\frac{4}{5}$ | - | - |
|  |  | A | - | - | $\frac{4}{5}$ | - |
|  |  | NI | - | - | - | $\frac{3}{5}$ |
| **Worksheets** | 3 | Completed | $\frac{33}{37}$ | $\frac{29}{37}$ | $\frac{25}{37}$ | $\frac{22}{37}$ |

The above table shows the fraction of given assignments. These fractions are minimum requirements for each letter grade.

The ranking indicates the relative importance of each assignment: Rank 1 is the most important, and Rank 3 is the least. If the mark distribution across assignments varies for you, this ranking will be used to determine your final grade. There will also be optional assignments that you may complete to contribute additional credit within each category.
...
*Amendment 4:* The final course grade percentages are converted into fractions to reflect the number of given assignments in each category.

*Amendment 5: * The sentences "The above table shows the percent of given assignments. These percentages are minimum requirements for each letter grade." was rewritten to "The above table shows the fraction of given assignments. These fractions are minimum requirements for each letter grade."

*Amendment 6: * Added the sentence "Each of you will receive an individual assignment marksheet in the middle of the semester to help you track your progress and current standing in the course." in the highlighted section.

*Amendment 7: * The sentence "The rank determines the importance of each assignment where 1 means the highest rank and 3 means lowest rank." was changed to "The ranking indicates the relative importance of each assignment: Rank 1 is the most important, and Rank 3 is the least. If the mark distribution across assignments varies for you, this ranking will be used to determine your final grade. There will also be optional assignments that you may complete to contribute additional credit within each category."
...
| [Applications of 1st-Order ODEs](lecture-notes/applications-of-1st-order-odes.pdf) | Ch. 4.1-4.3 @trench2013elementary |
...
| [Euler's Method](lecture-notes/eulers-method.pdf) | Ch. 3.1 @trench2013elementary |
| [2nd-Order ODEs \& Equilibriums](lecture-notes/2nd-order-odes-and-equilibriums.pdf) | - |
| [Existence and Uniqueness \& Principle of Superposition](lecture-notes/existence-and-uniqueness-and-principle-of-superposition.pdf) | - |
| [Characteristic Polynomials for Homogeneous Linear ODEs](lecture-notes/characteristic-polynomials-for-homogeneous-linear-odes.pdf) | Ch. 5.1-5.3 @trench2013elementary |
| [Undetermined Coefficients for Nonhomogeneous Linear ODEs](lecture-notes/undetermined-coefficients-for-nonhomogeneous-linear-odes.pdf) | Ch. 5.4-5.5 @trench2013elementary |
| [Variation of Parameters for Nonhomogeneous Linear ODEs](lecture-notes/variation-of-parameters-for-nonhomogeneous-linear-odes.pdf) | Ch. 5.7 |
| [Method of Reduction of Order](lecture-notes/method-of-reduction-of-order.pdf) | Ch. 5.6 @trench2013elementary |
| [System of 1st-Order ODEs \& Equilibriums](lecture-notes/system-of-1st-order-odes-and-equilibriums.pdf) | Ch. 10.1 @trench2013elementary |
| [Existence and Uniqueness \& Direction Fields and Phase Portraits](lecture-notes/existence-and-uniqueness-and-direction-fields-and-phase-portraits.pdf) | Ch. 10.2 @trench2013elementary |
| [Analyzing Equilibriums of a System of 1st-Order ODEs](lecture-notes/analyzing-equilibriums-of-a-system-of-1st-order-odes.pdf) | Ch. 10.3 @trench2013elementary |
...
| Distinct Eigenvalues | Ch. 10.4 @trench2013elementary |
| Repeated Eigenvalues | Ch. 10.5 @trench2013elementary |
...
| Laplace and Inverse Laplace Transforms | Ch. 8.1-8.2 \& Ch. 8.6 @trench2013elementary |
