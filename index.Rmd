...
This course meets on Mondays, Wednesdays, and Fridays. Wednesdays and Fridays will focus on discussing topics. Homework will be scheduled for alternating Mondays. The typical class routine will include pre-reading assignments before each class, followed by a short lecture or demonstration, worksheet activities, group presentations, and discussions.
...
> You can access the course website at [mth-321ab-fa25](){target="_blank"}.
...
> The Teams for this course is [MTH-321AB-fa25](){target="_blank"}. 
...
* Define ODEs and their basic structure, such as order, linearity, homogeneity, and autonomy.
* Define a 1st-order system of ODEs and their basic structure, such as linearity, homogeneity, and autonomy.
* Use direction fields, phase portraits, and linearization to analyze the qualitative behavior of solutions around equilibriums of linear and non-linear ODEs.
...
|  | F 8/29 | 1st-Order ODEs, Equilibrium, \& Existence and Uniqueness |
| **2** | M 9/1 | Slope Fields and Phase Diagrams |
|  | W 9/3 | Analyzing Equilibriums |
...
|  | W 9/17 | 2nd-Order ODEs, Equilibrium, \& Existence and Uniqueness |
|  | F 9/19 | Principle of Superposition |
| **5** | M 9/22 | Characteristic Polynomials for Homogeneous Linear ODEs |
|  | W 9/24 | _Review_ |
|  | F 9/26 | **Exam 1** |
...
| **7** | M 10/6 | System of 1st-Order ODEs, Equilibrium, \& Existence and Uniqueness   |
|  | W 10/8 | Direction Fields and Phase Portraits |
...
| **9** | M 10/20 | Eigenvalues and Eigenvectors for Homogeneous Linear Systems |
|  | W 10/22 | Stability Analysis by Linearization |
|  | F 10/24 | Bifurcations in Two Dimensions |
| **10** | M 10/27 | Applications of 2nd-Order ODEs and System of 1st-Order ODEs |
|  | W 10/29 | _Review_ |
|  | F 10/31 | **Exam 2** |
...
| **12** | M 11/10 | Laplace Transforms |
|  | W 11/12 | Inverse Laplace Transforms |
|  | F 11/14 | Linear ODE solutions using Laplace Transforms |
| **13** | M 11/17 | Higher-Order ODEs \& Existence and Uniqueness |
|  | W 11/19 | Linear System of ODEs in Higher Dimensions |
|  | F 11/21 | Series Solutions |
| **14** | M 11/24 | _Review_ |
|  | W 11/26 | **Exam 3** |
...
|  | F 12/5 | _Review_ |
| **16** | Tu 12/9 | **Final Exam Section A (1:30 PM - 3:30 PM)** |
|  | Th 12/11 | **Final Exam Section B (10:30 AM - 12:30 PM)** |
...
>
>   * **Section A:** Tu December 9, 1:30 PM - 3:30 PM, Franz Hall 205
>   * **Section B:** Th December 11, 10:30 AM - 12:30 PM, Franz Hall 205
...
| Classification of Equations \& Principles of Solutions | Ch. 1.1-1.2 \& Ch. 2.1 @trench2013elementary |
| 1st-Order ODEs, Equilibrium, \& Existence and Uniqueness | Ch. 2.3 @trench2013elementary |
| Slope Fields and Phase Diagrams | Ch. 1.3 @trench2013elementary |
| Analyzing Equilibriums | - |
| Bifurcations in One Dimension | - |
| Applications of 1st-Order ODEs | Ch. 4.1-4.3 @trench2013elementary |
| Separation of Variables | Ch. 2.2 @trench2013elementary |
| Integrating Factors | Ch. 2.6 @trench2013elementary |
| Euler's Method | Ch. 3.1 @trench2013elementary |
| 2nd-Order ODEs, Equilibrium, \& Existence and Uniqueness | - |
...
| System of 1st-Order ODEs, Equilibrium, \& Existence and Uniqueness | Ch. 10.1 @trench2013elementary |
| Direction Fields and Phase Portraits | Ch. 10.2 @trench2013elementary |
...
| Higher-Order ODEs \& Existence and Uniqueness | Ch. 9.1 @trench2013elementary |
